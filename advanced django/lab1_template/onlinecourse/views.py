...
#GenericClass-based course list view
...
#Generic Class-based course_details view
# Note that CourseDetailsView is now subclassing DetailView 
class CourseDetailsView(generic.DetailView):
    model = Course
    template_name = 'onlinecourse/course_detail.html'

# Enroll view stays as class based enroll view for this example
...
'''
# Class-based course_details view
